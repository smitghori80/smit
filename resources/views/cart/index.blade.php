                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <img src="{{url('image',$cartItem->options->img)}}" alt="no" width="200px">
...
{!!Form::close()!!}
                            ...
                            <td class="cart_delete">
                               <button class="btn btn-primary">
                                <a class="cart_quantity_delete" style="background-color:red" href="{{url('/cart/remove')}}/{{$cartItem->rowId}}">x<i class="fa fa-times" aria-hidden="true"></i></a>
                                   </button>
                            </td>
                        </tr>
